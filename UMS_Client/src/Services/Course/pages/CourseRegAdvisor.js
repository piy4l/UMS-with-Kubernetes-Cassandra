...
const CourseRegAdvisor = () => {
    ...
    useEffect(() => {
      const getCourse = async () =>{
        ...
        setBackendData(courseFromServer.pending)
        setBackendDataAccepted(courseFromServer.accepted)
      }
    ...
    const fetchCourse = async () =>{
      ...
      const res = await fetch("http://localhost:5002/advisor/requestedCourses?advisor_id=" + username);
                                ...
                                <tbody>
                                    {backendData.map((row)=>(
                                        <tr>
                                            ...
                                            <td><a href={`/advisor/course_registration/student/${row.student_id}`}> Continue</a></td>
...
export default CourseRegAdvisor;